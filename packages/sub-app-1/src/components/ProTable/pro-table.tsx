...
class ProTable extends Component<IProTableProps, any> {
  ...
  state = {
    ...
    selectedRows: [],
    collapsed: this.props.search === false ? undefined : this.props.search?.defaultCollapsed, // 之前设置的this.props.search.collapsed会失效，但问题不大
  };
  ...
  setSelectedRowKeys(selectedRowKeys) {
    this.setState({
      selectedRowKeys: Array.isArray(selectedRowKeys) ? selectedRowKeys : [selectedRowKeys],
    });
  }
